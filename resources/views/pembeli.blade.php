...
<header class="header">
          ...
          <div class="container-fluid">
            ...
            <nav>
              ...
              <li><a href="{{url('/about')}}">About Us </a></li>
                 <li class="active"><a href="javascript:void(0)">Pilih Rumah</a></li>
              </ul>
              </nav>
            </div>
          </div>
  ...
  </div><section class="banner"><img src="images/thi.jpg" alt="" class="img-responsive">
    <div class="container">
      <div class="bannerText">
        <div class="row">
   <div class="col-lg-12">
            <h2>Silahkan hubungi Admin Untuk Memulai Proses Pembelian</h2>
